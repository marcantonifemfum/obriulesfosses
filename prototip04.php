...
$pdfnomes = $PDFunic . "_obriulesfosses_prototip04.pdf";
...
// PEL VALOR DE RESOLUCIÓ -r establim una variable dinàmica de manera que partim de la comparativa que una pantalla d'ample 1920 px en té prou amb 144 ppp
// per deduir la resolució en ppp necessària hi comptem el ratio d'ample 1920 en relació a l'ample de la pantalla que ens crida i ho mutipliquem per 144
  $ppp = round((1920/$width)*144);
  //exit(" >>> " . $ppp);
  $command = $somaGS . "gs -q -dNOSAFER -r" . $ppp . " -o '" . $pngFile . "' -sDEVICE=png16m -dTextAlphaBits=4 -dGraphicsAlphaBits=4 -dMinFeatureSize=2 '" . $PSapplet . "'";
